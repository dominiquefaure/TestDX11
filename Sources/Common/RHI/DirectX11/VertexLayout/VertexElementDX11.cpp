...
VertexElementDX11::VertexElementDX11()
{
	...
	m_offset												=	0;
	m_inputSlot												=	0;
	m_type													=	RHI_VERTEX_ELEMENT_TYPE_NONE;
}
//-----------------------------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------------------------
void VertexElementDX11::Init( RhiVertexElementType a_type , TUint32 a_slot , TUint32 a_offset )
{
	m_type													=	a_type;
	m_inputSlot												=	a_slot;
	m_offset												=	a_offset;
...
//-----------------------------------------------------------------------------------------------
void VertexElementDX11::SetElementDescriptor( D3D11_INPUT_ELEMENT_DESC* a_desc )
{
